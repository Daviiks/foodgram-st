...
Коллекцию для тестирования можно взять из папки postman_collection
...
### Docker образ
Официальный Docker образ backend доступен на Docker Hub:
[daviiel/foodgram-backend](https://hub.docker.com/r/daviiel/foodgram-backend)
